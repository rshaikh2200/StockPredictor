...
export async function POST(req) {
  try {
    // Initialize the Bedrock Agent Runtime client with credentials
    const client = new BedrockAgentRuntimeClient({ 
      region: "us-east-1",
      credentials: fromEnv() // Correct placement of credentials
    });
    ...
    const input = {
      ...
      retrieveAndGenerateConfiguration: {
        ...
        knowledgeBaseConfiguration: {
          knowledgeBaseId: "HU531GZBOX", // Replace with your actual Knowledge Base ID
          ...
          generationConfiguration: {
            promptTemplate: {
              ...
              textPromptTemplate: "You are a helpful AI assistant for Job Hunt Tech. This is data you're given about Job Hunt Tech: $search_results$. Be concise and keep the message close to 150 words."
            },
            inferenceConfig: {
              textInferenceConfig: {
                temperature: 0.7,
